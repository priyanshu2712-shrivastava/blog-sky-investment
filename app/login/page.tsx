...
function LoginContent() {
    ...
    if (error === 'AccessDenied') {
        errorMessage = 'Access denied. Only authorized administrators can sign in.';
    ...
    return (
        <div className=" flex items-center justify-center h-screen w-full  px-6">
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                ...
                {errorMessage && (
                    <div className="bg-red-50 text-red-600 text-sm p-4 rounded-lg mb-6 border border-red-100">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all font-medium shadow-sm"
                >
